  ...
  frontend: {
    ...
    tech: [
      ...
      [
        ...
        SiExpo,
        "#ffffff",
        "A practical React Native platform for shipping consistent mobile experiences across devices.",
      ],
    ],
  },
  backend: {
    ...
    tech: [
      ...
      [
        ...
        SiLaravel,
        "#ff2d20",
        "A robust PHP framework for structured APIs, secure application logic, and dependable delivery.",
      ],
      [
        "PostgreSQL",
        SiPostgresql,
  ...
  delivery: {
    ...
    tech: [
      ...
      [
        ...
        SiLaravel,
        "#ff2d20",
        "I deliver complete, scalable web applications by integrating modern frontend interfaces with dependable backend systems.",
      ],
      [
        "React",
        SiReact,
